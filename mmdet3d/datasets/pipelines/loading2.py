...
@PIPELINES.register_module()
class LoadMultiViewImageFromFiles_2(object):
...
@PIPELINES.register_module()
class LoadImageFromFileMono3D_2(LoadImageFromFile):
...
@PIPELINES.register_module()
class LoadPointsFromMultiSweeps_2(object):
...
@PIPELINES.register_module()
class PointSegClassMapping_2(object):
...
@PIPELINES.register_module()
class NormalizePointsColor_2(object):
...
@PIPELINES.register_module()
class LoadPointsFromFile_2(object):
...
@PIPELINES.register_module()
class LoadAnnotations3D_2(LoadAnnotations):
    """Load Annotations3D.
